                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                          ...
                          <input type="hidden" name="page" value="{{ request('page') }}">
                            ...
                            <div>
                              <label for="nama" class="mb-1 block text-xs font-bold text-gray-700">Nama</label>
                              ...
                              @if($user->salary)
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div id="delivery-wrapper">
                                      @foreach ($salary->deliveries as $i => $delivery)
                                        <div class="flex flex-col gap-1 pb-2 border-b border-gray-500">
                                            <div>
                                              <input type="text" name="deliveries[{{ $i }}][kota]" value="{{ $delivery->kota ?? '' }}" placeholder="kota" class="w-full h-10 px-2 rounded-md border-2 border-gray-200 outline-none shadow-sm focus:border-gray-600">
                                            </div>
                                            <div>
                                              <input type="number" name="deliveries[{{ $i }}][jumlah_retase]" value="{{ $delivery->jumlah_retase ?? '' }}" placeholder="jumlah retase" class="w-full h-10 px-2 rounded-md border-2 border-gray-200 outline-none shadow-sm focus:border-gray-600">
                                            </div>
                                            <div>
                                              <input type="number" name="deliveries[{{ $i }}][tarif_retase]" value="{{ $delivery->tarif_retase ?? '' }}" placeholder="tarif retase" class="w-full h-10 px-2 rounded-md border-2 border-gray-200 outline-none shadow-sm focus:border-gray-600">
                                            </div>
                                  ...
                                  <div class="mt-4">
                                    ...
                                    <div class="flex mt-2">
                                      <button type="button" id="clear" class="bg-red-500 hover:bg-red-600 text-white px-4 py-1 rounded-md" disabled><i class="fas fa-broom text-sm mr-1"></i>Clear</button>
                                    </div>
                                  </div>
                                </div>
                              @endif
